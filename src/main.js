...
const translations = {
  es: {
    ...
    faq: {
      ...
      q2_desc: "Simplemente explore nuestro catálogo, haga clic en la obra que desee y presione 'Añadir al carrito'. Se añadirá a su carrito. Luego complete el formulario de checkout con sus datos de envío y de pago para formalizar la adquisición.",
  ...
  en: {
    ...
    faq: {
      ...
      q2_desc: "Simply explore our catalog, click on your desired artwork, and press 'Add to cart'. It will be added to your cart. Then complete the checkout form with your shipping and payment details to finalize the acquisition.",
